      ...
      <div className="flex min-h-screen">
                  ...
                  <div className="mt-1 grid grid-cols-3 gap-3">
                    <div>
                      <a className="inline-flex w-full justify-center rounded-md border border-gray-300 bg-white py-2 px-4 text-sm font-medium text-gray-500 shadow-sm hover:bg-gray-50">
                        <span className="sr-only">Login in with Facebook</span>
                        <svg
                          className="h-5 w-5"
                          aria-hidden="true"
                          fill="currentColor"
                    ...
                    <div>
                      <a className="inline-flex w-full justify-center rounded-md border border-gray-300 bg-white py-2 px-4 text-sm font-medium text-gray-500 shadow-sm hover:bg-gray-50">
                        <span className="sr-only">Login in with GitHub</span>
                        <svg
                          className="h-5 w-5"
                          aria-hidden="true"
                          fill="currentColor"
        ...
        <div className="relative hidden w-0 flex-1 lg:block">
          <img
            ...
            src="https://4kwallpapers.com/images/walls/thumbs_3t/9611.jpg"
            alt=""
          />
        </div>
      </div>
