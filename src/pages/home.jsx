...
import { navigationFooter, navigation } from "../constant/index";
  ...
  return (
    <div className="isolate bg-white">
      ...
      <div className="px-6 pt-6 lg:px-8">
        <div>
          <nav
            className="flex h-16 px-4 fixed top-0 backdrop-blur-xl bg-opacity-25 bg-white right-0 left-0 z-10  items-center justify-between "
            aria-label="Global"
          >
            <div className="flex lg:min-w-0 lg:flex-1" aria-label="Global">
              <a className="-m-1.5 p-1.5">
                ...
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  class="w-9 h-10 text-indigo-600"
                >
                  <path
                    fill-rule="evenodd"
                ...
                <div className="-my-6 divide-y divide-gray-500/10">
                  <div className="space-y-2 py-6">
                    {navigation.map((item) => (
                      <a
                        key={item.name}
                        onClick={() => window.scrollTo(item.href)}
                        // href={item.href}
      ...
      <div
        id="target"
        className="relative bg-white px-6 pt-16 pb-20 lg:px-8 lg:pt-24 lg:pb-28"
      >
